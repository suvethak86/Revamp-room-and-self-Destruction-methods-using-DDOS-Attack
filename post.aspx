...
<body>
    ...
    <div>
        ...
        <asp:FileUpload ID="FileUpload1" runat="server" Style="z-index: 102; left: 984px;
            position: absolute; top: 292px" Font-Names="Rockwell" Font-Size="18pt" Width="213px" />
        <asp:Button ID="Button1" runat="server" BackColor="#004040" Font-Bold="True" Font-Size="25pt"
            ForeColor="White" Style="z-index: 103; left: 675px; position: absolute; top: 364px"
            Text="Room 1" Font-Names="Traditional Arabic" Height="69px" Width="196px" />
        &nbsp;
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Traditional Arabic"
            ...
            top: 121px" Text="User Name"></asp:Label>
        ...
        <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/3.jpeg"
            
            Style="z-index: 110; left: 4px; position: absolute; top: 2px; height: 433px; width: 496px; margin-top: 0px;" />
        <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Algerian"
            ...
            top: 19px" Text="ROOM - 1" Width="195px"></asp:Label>
