<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ssd.aspx.vb" Inherits="ssd" %>
...
<body>
      <form id="form1" runat="server">
          <div>
              ...
              <asp:Button ID="Button1" runat="server" BackColor="Red" Font-Bold="True" Font-Names="Traditional Arabic"
                  Font-Size="25pt" ForeColor="White" Height="69px" Style="z-index: 103; left: 675px;
                  position: absolute; top: 364px" Text="Submit" Width="196px" />
              &nbsp;
              ...
              <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Traditional Arabic"
                  ...
                  top: 121px" Text="Employe Name"></asp:Label>
              ...
              <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/selff.jpg"
                  
                  Style="z-index: 110; left: 4px; position: absolute; top: 2px; height: 364px; width: 431px;" />
              <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Algerian"
                  ...
                  top: 19px" Width="195px"></asp:Label>
          </div>
    </form>
</body>
</html>
