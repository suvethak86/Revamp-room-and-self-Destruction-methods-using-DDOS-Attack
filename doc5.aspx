<%@ Page Language="VB" AutoEventWireup="false" CodeFile="doc5.aspx.vb" Inherits="doc5" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Algerian"
                ...
                top: 3px" Text="ROOM - 5" Width="175px"></asp:Label>
            ...
            <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:revamppConnectionString %>"
                SelectCommand="SELECT * FROM [doc5] WHERE ([username] = @username)">
                <SelectParameters>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:revamppConnectionString %>"
                SelectCommand="SELECT * FROM [doc5]"></asp:SqlDataSource>
