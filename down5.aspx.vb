...
Partial Class down5
    ...
    Private Sub sea()
        ...
        Dim sql = "SELECT did FROM doc5 WHERE did = '" & Me.TextBox2.Text & "'"
    ...
    Private Sub revamp()
        ...
        Dim sql As String = "insert into doc select * from doc5 where did='" & Me.TextBox2.Text & "'"
        connection.Open()
    ...
    Private Sub del()
        ...
        connectionString = "Data Source=.\SQLEXPRESS;Initial Catalog=revampp;Integrated Security=True"
        connection = New SqlConnection(connectionString)
        Dim sql As String = "delete from doc5 where did='" & Me.TextBox2.Text & "'"
        connection.Open()
        Dim cmd As New SqlCommand(sql, connection)
        cmd.ExecuteNonQuery()
        connection.Close()
    ...
    Private Sub msg()
        ...
        connectionString = "Data Source=.\SQLEXPRESS;Initial Catalog=revampp;Integrated Security=True"
        connection = New SqlConnection(connectionString)
        Dim sql As String = "insert into msg values('" & Me.TextBox1.Text & "','" & Me.TextBox2.Text & "','your data revamped into room1')"
        connection.Open()
        Dim cmd As New SqlCommand(sql, connection)
        cmd.ExecuteNonQuery()
        connection.Close()
