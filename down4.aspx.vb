...
Partial Class down4
    ...
    Private Sub sea()
        ...
        Dim sql = "SELECT did FROM doc4 WHERE did = '" & Me.TextBox2.Text & "'"
    ...
    Private Sub revamp()
        ...
        Dim sql As String = "insert into doc5 select * from doc4 where did='" & Me.TextBox2.Text & "'"
        connection.Open()
    ...
    Private Sub del()
        ...
        connectionString = "Data Source=.\SQLEXPRESS;Initial Catalog=revampp;Integrated Security=True"
        connection = New SqlConnection(connectionString)
        Dim sql As String = "delete from doc4 where did='" & Me.TextBox2.Text & "'"
        connection.Open()
        Dim cmd As New SqlCommand(sql, connection)
        cmd.ExecuteNonQuery()
        connection.Close()
    ...
    Private Sub msg()
        ...
        connectionString = "Data Source=.\SQLEXPRESS;Initial Catalog=revampp;Integrated Security=True"
        connection = New SqlConnection(connectionString)
        Dim sql As String = "insert into msg values('" & Me.TextBox1.Text & "','" & Me.TextBox2.Text & "','your data revamped into room5')"
        connection.Open()
        Dim cmd As New SqlCommand(sql, connection)
        cmd.ExecuteNonQuery()
        connection.Close()
