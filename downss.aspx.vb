...
Partial Class downss
    ...
    Private Sub sea()
        ...
        Dim sql = "SELECT did FROM docss WHERE did = '" & Me.TextBox2.Text & "'"
    ...
    Private Sub chh()
        ...
        Else
            Me.Response.Redirect("docx.aspx")
        End If
    End Sub
    Private Sub revamp()
    ...
    Private Sub del()
        ...
        Dim sql As String = "delete from docss where did='" & Me.TextBox2.Text & "'"
        connection.Open()
    ...
    Private Sub msg()
        ...
        connectionString = "Data Source=.\SQLEXPRESS;Initial Catalog=revampp;Integrated Security=True"
        connection = New SqlConnection(connectionString)
        Dim sql As String = "insert into msg values('" & Me.TextBox1.Text & "','" & Me.TextBox2.Text & "','your data Deleted')"
        connection.Open()
        Dim cmd As New SqlCommand(sql, connection)
        cmd.ExecuteNonQuery()
        connection.Close()
