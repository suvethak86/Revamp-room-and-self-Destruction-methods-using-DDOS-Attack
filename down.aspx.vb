...
Partial Class down
    ...
    Private Sub sea()
        ...
        Dim sql = "SELECT did FROM doc WHERE did = '" & Me.TextBox2.Text & "'"
    ...
    Private Sub chh()
        ...
        Else
            Me.Response.Redirect("loading.aspx")
        End If
    End Sub
    Private Sub revamp()
        ...
        Dim sql As String = "insert into doc2  select * from doc where did='" & Me.TextBox2.Text & "'"
        connection.Open()
    ...
    Private Sub msg()
        ...
        connectionString = "Data Source=.\SQLEXPRESS;Initial Catalog=revampp;Integrated Security=True"
        connection = New SqlConnection(connectionString)
        Dim sql As String = "insert into msg values('" & Me.TextBox1.Text & "','" & Me.TextBox2.Text & "','your data revamped into room2')"
        connection.Open()
        Dim cmd As New SqlCommand(sql, connection)
        cmd.ExecuteNonQuery()
        connection.Close()
