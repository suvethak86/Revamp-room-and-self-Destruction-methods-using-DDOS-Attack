<%@ Page Language="VB" AutoEventWireup="false" CodeFile="room2.aspx.vb" Inherits="room2" %>
      ...
      <form id="form1" runat="server">
          <div>
              ...
              <asp:Button ID="Button1" runat="server" BackColor="#004040" Font-Bold="True" Font-Names="Traditional Arabic"
                  ...
                  position: absolute; top: 364px" Text="Room 2" Width="196px" />
              &nbsp;
              ...
              <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Algerian"
                  ...
                  top: 19px" Text="ROOM - 2" Width="195px"></asp:Label>
          </div>
    </form>
</body>
</html>
