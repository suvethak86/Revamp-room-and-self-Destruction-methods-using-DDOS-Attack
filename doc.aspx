...
<body>
    ...
    <div>
        <asp:TextBox ID="TextBox1" runat="server" Font-Bold="True" Font-Size="20pt" ForeColor="#004040"
            Style="z-index: 100; left: 310px; position: absolute; top: 73px" Height="38px" Width="252px"></asp:TextBox>
        &nbsp; &nbsp;&nbsp;
        ...
        <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Algerian"
            ...
            top: 3px" Text="ROOM - 1" Width="175px"></asp:Label><asp:Button ID="Button2" runat="server" BackColor="#004040" Font-Bold="True" Font-Size="25pt"
