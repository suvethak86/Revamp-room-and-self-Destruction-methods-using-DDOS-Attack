<%@ Page Language="VB" AutoEventWireup="false" CodeFile="doc2.aspx.vb" Inherits="doc2" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <asp:ImageButton ID="ImageButton1" runat="server" Height="139px" ImageUrl="~/images/large-home-button-amber.jpg"
                Style="z-index: 102; left: 1157px; position: absolute; top: 1px" Width="143px" />
            ...
            <asp:Label ID="Label6" runat="server" BackColor="White" Font-Bold="False" Font-Names="Algerian"
                Font-Size="30pt" ForeColor="#0000C0" Style="z-index: 107; left: 211px; position: absolute;
                top: 5px" Text="ROOM - 2" Width="189px"></asp:Label>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                DataSourceID="SqlDataSource2" Font-Size="20pt" ForeColor="#333333" GridLines="None"
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:revamppConnectionString %>"
                SelectCommand="SELECT * FROM [doc2] WHERE ([username] = @username)">
                <SelectParameters>
